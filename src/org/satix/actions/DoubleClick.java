...
/**
 * This class defines the doubleClick action which double clicks on an element
...
public class DoubleClick extends Action {
	private static final String CLASSNAME = DoubleClick.class.getSimpleName();
	...
	public void run(WebDriver driver) throws ActionException {
		...
		try {
			...
			builder.doubleClick(toElement).perform();
